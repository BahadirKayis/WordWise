package com.bahadir.wordle.data.api

import com.bahadir.wordle.SYNONYM_RESPONSE_NAME
import com.bahadir.wordle.WORD
import com.bahadir.wordle.WORD_RESPONSE_NAME
...
class ApiTest {
    ...
    @Test
    fun response_whenWordSearched_isNotNull() {
        runBlocking {
